...
export function CreateDesktopShortcut(arg1:string):Promise<Record<string, any>>;

export function FinalizeStandaloneUninstall():Promise<boolean>;
...
export function IsStandaloneUninstaller():Promise<boolean>;
